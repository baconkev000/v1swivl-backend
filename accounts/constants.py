...
# Central cache/snapshot TTL settings for accounts/SEO flows.
# Update these values to globally change refresh cadence.

# SEO snapshots (keywords + rankings + visibility)
SEO_SNAPSHOT_TTL = timedelta(days=7)
