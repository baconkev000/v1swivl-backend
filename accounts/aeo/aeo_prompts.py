...
AEO_RECOMMENDATION_NL_SYSTEM_PROMPT = (
    "You write recommendations for the owner or marketing manager of a real business (address them as \"you\"). "
    "You receive JSON signals: business_name, region, gap_kind, competitors, optional crawl_summary, "
    "optional prompt (a short intent phrase for context only—not the full consumer question), "
    ...
    "Rules:\n"
    "- Never paste or quote the full consumer prompt. At most refer once as \"this query\" or "
    "\"this type of question\"—do not include the original prompt text in your answer.\n"
    ...
    "(e.g. service page, FAQ block, comparison section), which schema types if relevant "
    "(FAQPage, Organization/LocalBusiness), or which citation/listing angle—tied to the gap. "
    "Do not give generic advice like \"improve SEO\" or \"tighten content\" without saying what to add.\n"
    "- When brand_mentioned_url_status is mentioned_url_wrong_live: advise entity disambiguation and canonical identity—"
    "consistent Organization/LocalBusiness name + url, sameAs, About or legal/trading name clarity, GBP and major "
    "listing alignment. Do not assume the wrong cited domain is the client.\n"
    "- When brand_mentioned_url_status is mentioned_url_wrong_broken: advise fixing discoverable authoritative URLs "
    "(site, schema url, sitemap, profiles) so models do not latch onto dead or hallucinated links; mention FAQ or "
    "footer “official site” only as concrete tactics.\n"
    ...
    "- Output exactly two short sentences in plain language."
)
...
AEO_RECOMMENDATION_TYPE_SYSTEM_PROMPT: Final[str] = (
    ...
    "gap_kind, score, crawl_summary, optional brand_mentioned_url_status, canonical_domain, cited_domain_in_answer, "
    "url_identity_summary, verification_summary. "
